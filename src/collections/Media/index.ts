...
import { generateCustomFields, defaultMediaCustomFields } from './fields/customFields'
...
export const generateMediaCollection = (
  ...
  const fields: Field[] = [
    ...
    ...cloudinaryFields,
    ...(cloudinaryOptions.versioning?.enabled && cloudinaryOptions.versioning?.storeHistory ? versionFields : []),
  ]
